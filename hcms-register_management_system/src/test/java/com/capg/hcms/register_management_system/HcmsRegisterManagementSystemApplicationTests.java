...
class HcmsRegisterManagementSystemApplicationTests {
	...
	{	
	   ...
	   user2=new User("","Surya"     ,"IloveIndia1",new BigInteger("7893732190"),"surya@gmail.com"     ,"ADMIN",47, "male");
	...
	{
		assertEquals(true,service.validateUser("RohanUser","IluvU3000")!=null);
	}
	...
	void testValidateUserException()
	{
	    ...
	    {
	    	service.validateUser("RohanUser1","IluvU3000");
	    });
	}
	...
	void testValidateUserException1()
	{
		Assertions.assertThrows(UserNotFoundException.class, ()->
	    {
	    	service.validateUser("RohanUser","IluvU5000");
	    });
	}
}